...
# AdaBoost的核心思想是用反复修改的数据来训练一系列的弱学习器，
# 由这些若学习器的预测结果通过加权投票（或加权求和）的方式组合，得到最终的预测结果

# AdaBoost既可以用在分类问题也可以用在回归问题
# 对于 multi-class 分类， AdaBoostClassifier 实现了 AdaBoost-SAMME 和 AdaBoost-SAMME.R
# 对于回归， AdaBoostRegressor 实现了 AdaBoost.R2
